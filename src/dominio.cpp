...
//Implementação dos métodos das classes de domínio (Unidade,Integracao, Fumaca, Sistema, Regressao,Aceitacao)
...
std::string Unidade::getCodigo() const{
  return codigo;
}
...
std::string Integracao::getCodigo() const{
  return codigo;
}
...
std::string Fumaca::getCodigo() const{
  return codigo;
}
...
std::string Sistema::getCodigo() const{
  return codigo;
}
...
std::string Regressao::getCodigo() const{
  return codigo;
}
